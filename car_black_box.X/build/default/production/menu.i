...
void set_time(void) {
    ...
    clcd_print((const unsigned char*)"HH:MM:SS",(0x80 + (3)));
    ...
    while (1) {
        ...
        if ( field == 3 && blink_flag ) {
            clcd_print((const unsigned char*)"  ",(0xC0 + (3)));
        } else {
            clcd_putch(hr/10 + '0',(0xC0 + (3)));
            clcd_putch(hr%10 + '0',(0xC0 + (4)));
        }

        clcd_putch(':', (0xC0 + (5)));

        if ( field == 2 && blink_flag ) {
            clcd_print((const unsigned char*)"  ",(0xC0 + (6)));
        } else {
        ...
        if ( field == 1 && blink_flag ) {
            clcd_print((const unsigned char*)"  ",(0xC0 + (9)));
        } else {
